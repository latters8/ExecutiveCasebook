...
const data = {
  ru: {
    ...
    heroText: [
      '<p class="hero__text-lead">«Рост замедляется не из-за отсутствия идей.</p><p class="hero__text-lead" style="margin-top: -0.3rem;">А потому, что маркетинг, продажи и стратегия работают изолированно.»</p>',
    ...
    nodes: ['лет опыта', 'оборот (₽)', 'брендов', 'SKU', 'дилеров', 'рост лидов', 'пунктов ИКС', 'рост продаж', 'магазинов', 'сотрудников', 'бюджет', 'внедрение'],
  ...
  en: {
    ...
    nodes: ['years of experience', 'turnover (₽)', 'brands', 'SKU', 'dealers', 'lead growth', 'ICS points', 'sales growth', 'stores', 'employees', 'budget', 'AI implementation'],
...
function renderMetrics() {
  ...
  const nodeIds = ['n1','n2','n3','n4','n5','n6','n7','n8','n9','n10','n11','n12'];
  d.nodes.forEach((label, i) => {
    if (nodeIds[i]) document.getElementById(nodeIds[i]).textContent = label;
  });
}
